const Content = () => {
  return (
    <p className="text-fade-anim p-4 text-justify text-base text-primary-light dark:text-primary-dark">
      ...
      <span className="text-gradient">neo-brutalism</span>, as you can see in
      this website.
      <br />
      <br />
      fascinated by the <span className="text-gradient">internet</span> and{" "}
      <span className="text-gradient">computers</span>, i've always wanted to
      make those programs myself and — that's why i'm{" "}
      ...
      <span className="text-gradient">mobile legends</span>, and also watching{" "}
      <span className="text-gradient">anime</span> sometimes. if you're
      interested, hit me up on my{" "}
